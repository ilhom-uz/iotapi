...
class TemperaturesControllerTest < ActionController::TestCase
  ...
  test "should create temperature" do
    assert_difference('Temperature.count') do
      post :create, temperature: { gas: @temperature.gas, humidity: @temperature.humidity, temp: @temperature.temp, title: @temperature.title }
    end
  ...
  test "should update temperature" do
    patch :update, id: @temperature, temperature: { gas: @temperature.gas, humidity: @temperature.humidity, temp: @temperature.temp, title: @temperature.title }
    assert_redirected_to temperature_path(assigns(:temperature))
  end
